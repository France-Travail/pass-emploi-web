...
function RecapitulatifErreursFormulaire(
  ...
  if (erreurs.length === 0) {
    return <div ref={ref} className='' tabIndex={-1} />
  }
  ...
  return (
    <div
      ref={ref}
      role='alert'
      aria-label={`Le formulaire contient ${erreurs.length} erreur(s).`}
      className='text-warning bg-warning-lighten p-6 rounded-base mb-8'
      tabIndex={-1}
    >
